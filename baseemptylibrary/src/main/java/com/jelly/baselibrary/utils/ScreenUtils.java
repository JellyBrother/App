...
public final class ScreenUtils {
     ...
     * @return the distance between the given View's X (start point of View's width) and the screen width.
     */
    public int calculateDistanceByX(Context context, View view) {
        int[] point = new int[2];
        view.getLocationOnScreen(point);
        return getScreenWidth(context) - point[0];
    }
     ...
     * @return the distance between the given View's Y (start point of View's height) and the screen height.
     */
    public int calculateDistanceByY(Context context, View view) {
        int[] point = new int[2];
        view.getLocationOnScreen(point);
        return getScreenHeight(context) - point[1];
    }
