package com.jelly.wxtool.message.utils;
...
public abstract class AbstractTFUtil<T> {
    /**
     * 是包含还必须相等;
     */
    ...
    private AbstractTFUtil(@NonNull T checkData, boolean isEquals) {
     ...
     */
    private static class IdTF extends AbstractTFUtil<String> implements IdTextTF {
     ...
     */
    private static class TextTF extends AbstractTFUtil<String> implements IdTextTF {
     ...
     */
    private static class WebTextTF extends AbstractTFUtil<String> {
     ...
     */
    private static class ContentDescriptionTF extends AbstractTFUtil<String> {
     ...
     * 找ClassName匹配
     */
    private static class ClassNameTF extends AbstractTFUtil<String> {
     ...
     * 在某个区域内的控件
     */
    private static class RectTF extends AbstractTFUtil<Rect> {
     ...
     */
    public static AbstractTFUtil newId(String pageName, String idName) {
     ...
     */
    public static AbstractTFUtil newId(@NonNull String idfullName) {
     ...
     * 和找id一样效率最高，如果能找到，尽量使用这个
     */
    public static AbstractTFUtil newText(@NonNull String text, boolean isEquals) {
     ...
     * 类似uc浏览器，有text值但无法直接根据text来找到
     */
    public static AbstractTFUtil newWebText(@NonNull String webText, boolean isEquals) {
     ...
     * 找ContentDescription字段
     */
    public static AbstractTFUtil newContentDescription(@NonNull String cd, boolean isEquals) {
     ...
     * 找ClassName匹配
     */
    public static AbstractTFUtil newClassName(@NonNull String className) {
        return new ClassNameTF(className, true);
    }

    public static AbstractTFUtil newClassName(@NonNull String className, boolean isEquals) {
     ...
     * 在某个区域内的控件
     */
    public static AbstractTFUtil newRect(@NonNull Rect rect) {
