 ...
 */
public class AddFriendService4 extends AccessibilityService {
    private static final String TAG = AddFriendService4.class.getSimpleName();
    ...
    protected void onServiceConnected() {
        ...
        Toast.makeText(this, "辅助开启了", Toast.LENGTH_LONG).show();
    ...
    public void onDestroy() {
        Log.i(TAG, "onDestroy: ");
        Toast.makeText(this, "服务停止了，请重新开启", Toast.LENGTH_LONG).show();
        // 服务停止，重新进入系统设置界面
