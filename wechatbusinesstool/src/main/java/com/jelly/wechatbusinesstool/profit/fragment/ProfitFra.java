package com.jelly.wechatbusinesstool.profit.fragment;
...
public class ProfitFra extends BaseFragment {
    private static final String TAG = "ProfitFra";
...
//        return mRootView;
    ...
    private void initViews(View rootView) {
        ...
        mTvDesc.setText(R.string.wbt_profit_fra_name);
    }
