...
class NestedVerticalParentRecyclerView : RecyclerView {
...
//                        LogUtils.dTag("select-nestScroll-parentRecycler", "滑动系列列表：否")
...
//                        return false
//                    }
//                    LogUtils.dTag("select-nestScroll-parentRecycler", "滑动系列列表：是")
