...
import com.example.myapp.base.utils.ImageUtils;
...
import com.example.myapp.base.utils.UtilsActivityLifecycleImpl;
...
public final class ToastUtils {
    ...
    public final void show(@StringRes final int resId) {
        show(StringUtils.getString(resId), getDuration(), this);
    }
    ...
    public final void show(@StringRes final int resId, final Object... args) {
        show(StringUtils.getString(resId, args), getDuration(), this);
    }
    ...
    private View tryApplyUtilsToastView(final CharSequence text) {
        ...
        View toastView = ViewUtils.layoutId2View(R.layout.base_toast_view);
    ...
    public static void showShort(@StringRes final int resId) {
        show(StringUtils.getString(resId), Toast.LENGTH_SHORT, DEFAULT_MAKER);
    }
    ...
    public static void showShort(@StringRes final int resId, final Object... args) {
        show(StringUtils.getString(resId, args), Toast.LENGTH_SHORT, DEFAULT_MAKER);
    }
    ...
    public static void showLong(@StringRes final int resId) {
        show(StringUtils.getString(resId), Toast.LENGTH_LONG, DEFAULT_MAKER);
    }
    ...
    public static void showLong(@StringRes final int resId, final Object... args) {
        show(StringUtils.getString(resId, args), Toast.LENGTH_LONG, DEFAULT_MAKER);
    }
    ...
    static final class ActivityToast extends AbsToast {
        ...
        public void show(int duration) {
            if (mToast == null) return;
            if (!UtilsActivityLifecycleImpl.getInstance().isAppForeground()) {
                // try to use system toast
                iToast = showSystemToast(duration);
                return;
            }
            boolean hasAliveActivity = false;
            for (final Activity activity : UtilsActivityLifecycleImpl.getInstance().getActivityList()) {
        ...
        public void cancel() {
            if (isShowing()) {
                ...
                for (Activity activity : UtilsActivityLifecycleImpl.getInstance().getActivityList()) {
                    if (!ActivityUtils.isActivityAlive(activity)) {
                        continue;
                    }
        ...
        private void showWithActivityView(final Activity activity, final int index, boolean useAnim) {
            ...
            if (window != null) {
                ...
                lp.bottomMargin = mToast.getYOffset() + ImmersionBar.getNavigationBarHeight(activity);
                lp.topMargin = mToast.getYOffset() + ImmersionBar.getStatusBarHeight(activity);
        ...
        private void registerLifecycleCallback() {
            ...
            UtilsActivityLifecycleImpl.getInstance().addActivityLifecycleCallbacks(mActivityLifecycleCallbacks);
        }

        private void unregisterLifecycleCallback() {
            UtilsActivityLifecycleImpl.getInstance().removeActivityLifecycleCallbacks(mActivityLifecycleCallbacks);
    ...
    static abstract class AbsToast implements IToast {
        ...
        public void setToastView(CharSequence text) {
            ...
            if (mToastView == null || mToastView.findViewById(android.R.id.message) == null) {
                setToastView(ViewUtils.layoutId2View(R.layout.base_toast_view));
            }
