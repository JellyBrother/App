...
public final class RomUtils {
    ...
    /**
     * 获取渠道包
     * 渠道：common通用包，huawei华为包，oppo欧珀包，vivo维沃包，xiaomi小米包，honor荣耀包，qqdownloader应用宝
     */
    public static String getChannel() {
        String channel = MetaDataUtils.getMetaDataInApp("BaiduMobAd_CHANNEL");
        LogUtils.d("getChannel channel:" + channel);
        return channel;
    }
     ...
     * @return true是通用的渠道包
     */
    public static boolean isChannelCommon() {
        return TextUtils.equals(getChannel(), "common");
    }
     ...
     * 是否是oppo的渠道包
     *
     * @return true是oppo的渠道包
     */
    public static boolean isChannelOppo() {
        return TextUtils.equals(getChannel(), "oppo");
    }

    /**
     * 是否是vivo的渠道包
     *
     * @return true是vivo的渠道包
     */
     ...
     * 是否是xiaomi的渠道包
     *
     * @return true是xiaomi的渠道包
     */
    public static boolean isChannelXiaomi() {
        return TextUtils.equals(getChannel(), "xiaomi");
    }

    /**
     * 是否是honor的渠道包
     *
     * @return true是Honor的渠道包
     */
    public static boolean isChannelhonor() {
        return TextUtils.equals(getChannel(), "honor");
    }

    /**
     * 是否是tencent的渠道包
     *
     * @return true是tencent的渠道包
     */
    public static boolean isChannelTencent() {
        return TextUtils.equals(getChannel(), "tencent");
    }
}