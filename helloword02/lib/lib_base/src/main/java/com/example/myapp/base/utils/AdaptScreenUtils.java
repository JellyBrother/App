...
public final class AdaptScreenUtils {
    ...
    public static Resources closeAdapt(@NonNull final Resources resources) {
        float newXdpi = Utils.getApp().getResources().getDisplayMetrics().density * 72f;
        applyDisplayMetrics(resources, newXdpi);
        return resources;
    }
    ...
    private static void preLoad() {
        applyDisplayMetrics(Utils.getApp().getResources(), Utils.getApp().getResources().getDisplayMetrics().xdpi);
    }
    ...
    private static void applyMetricsFields(final Resources resources, final float newXdpi) {
        for (Field metricsField : sMetricsFields) {
            try {
                ...
                LogUtils.e("applyMetricsFields",e);
            }
        }
    }
