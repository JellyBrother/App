...
public class MessengerUtils {
    ...
    public static void register() {
        if (UtilsBridge.isMainProcess()) {
            if (UtilsBridge.isServiceRunning(ServerService.class.getName())) {
                LogUtils.i("MessengerUtils", "Server service is running.");
                return;
            }
        ...
        if (sLocalClient == null) {
            ...
            if (client.bind()) {
                ...
                LogUtils.e("MessengerUtils", "Bind service failed.");
            }
        } else {
            LogUtils.i("MessengerUtils", "The client have been bind.");
        }
    }
    ...
    public static void unregister() {
        if (UtilsBridge.isMainProcess()) {
            if (!UtilsBridge.isServiceRunning(ServerService.class.getName())) {
                LogUtils.i("MessengerUtils", "Server service isn't running.");
                return;
            }
    ...
    public static void register(final String pkgName) {
        if (sClientMap.containsKey(pkgName)) {
            LogUtils.i("MessengerUtils", "register: client registered: " + pkgName);
            return;
        }
        ...
        if (client.bind()) {
            ...
            LogUtils.e("MessengerUtils", "register: client bind failed: " + pkgName);
        }
    }

    public static void unregister(final String pkgName) {
        if (!sClientMap.containsKey(pkgName)) {
            LogUtils.i("MessengerUtils", "unregister: client didn't register: " + pkgName);
            return;
        }
    ...
    static class Client {
        ...
        ServiceConnection mConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                LogUtils.d("MessengerUtils", "client service connected " + name);
            ...
            public void onServiceDisconnected(ComponentName name) {
                LogUtils.w("MessengerUtils", "client service disconnected:" + name);
                mServer = null;
                if (!bind()) {
                    LogUtils.e("MessengerUtils", "client service rebind failed: " + name);
                }
            }
        };
        ...
        boolean bind() {
            ...
            if (UtilsBridge.isAppInstalled(mPkgName)) {
                if (UtilsBridge.isAppRunning(mPkgName)) {
                    ...
                    LogUtils.e("MessengerUtils", "bind: the app is not running -> " + mPkgName);
                    return false;
                }
            } else {
                LogUtils.e("MessengerUtils", "bind: the app is not installed -> " + mPkgName);
                return false;
            }
        }
        ...
        void sendMsg2Server(Bundle bundle) {
            if (mServer == null) {
                ...
                LogUtils.i("MessengerUtils", "save the bundle " + bundle);
            } else {
                sendCachedMsg2Server();
