...
public class ClickUtils {
    ...
    public static final long INTERVAL_TIME_1000 = 1000;
    ...
    public static void expandClickArea(@NonNull final View view,
        ...
        if (parentView == null) {
            LogUtils.e("ClickUtils", "expandClickArea must have parent view.");
            return;
        }
...
//                UtilsBridge.toastCancel();
    ...
    static class ClickDrawableWrapper extends ShadowUtils.DrawableWrapper {
        ...
        public void draw(Canvas canvas) {
            if (mBitmapDrawable == null) {
                ...
                mBitmapDrawable = new BitmapDrawable(Utils.getApp().getResources(), bitmap);
    ...
    private static final HashMap<String, Long> sDoubleClickMap = new LinkedHashMap<String, Long>() {
        @Override
     ...
     * 是否重复点击
     *
     * @param routerPath 重复标识，建议用路由地址
     * @return true 重复点击
     */
    public static boolean isDupClick(String routerPath) {
        return isDupClick(routerPath, DEBOUNCING_DEFAULT_VALUE);
    }
     ...
     * @return true 重复点击
     */
    public static boolean isDupClick(String routerPath, long intervalTime) {
        long currentTime = System.currentTimeMillis();
        if (!sDoubleClickMap.containsKey(routerPath)) {
            sDoubleClickMap.put(routerPath, currentTime);
            LogUtils.d("isDupClick false no contains,routerPath:" + routerPath);
            return false;
        }
        Long oldTime = sDoubleClickMap.get(routerPath);
        if (currentTime - oldTime > intervalTime) {
            sDoubleClickMap.put(routerPath, currentTime);
            LogUtils.d("isDupClick false > 500,routerPath:" + routerPath);
            return false;
        }
        LogUtils.d("isDupClick true,routerPath:" + routerPath);
        return true;
    }
}
