...
public final class ScreenUtils {
    ...
    public static float getScreenXDpi() {
        return Utils.getApp().getResources().getDisplayMetrics().xdpi;
    }
    ...
    public static float getScreenYDpi() {
        return Utils.getApp().getResources().getDisplayMetrics().ydpi;
    }
    ...
    public static void fullScreen(boolean enable, Context context) {
