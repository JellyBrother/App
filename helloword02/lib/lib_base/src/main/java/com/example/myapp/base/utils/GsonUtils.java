...
public final class GsonUtils {
    ...
    private static final String KEY_DISABLE_HTML_ESCAPING_GSON = "disableHtmlEscapingGson";
    ...
    public static Gson getDisableHtmlEscapingGson() {
        Gson gsonDefault = GSONS.get(KEY_DISABLE_HTML_ESCAPING_GSON);
        if (gsonDefault == null) {
            gsonDefault = GsonFactory.newGsonBuilder().disableHtmlEscaping().create();
            GSONS.put(KEY_DISABLE_HTML_ESCAPING_GSON, gsonDefault);
        }
        return gsonDefault;
    }
    ...
    public static Gson getGson() {
        ...
        if (gsonDefault == null) {
            gsonDefault = GsonFactory
                    .newGsonBuilder()
                    .serializeNulls()
                    .registerTypeAdapterFactory(TypeAdapters.newFactory(String.class, new NullStringTypeAdapter()))
                    .create();
    ...
    public static String toJsonEmpty(final Object object) {
        if (object == null) {
            return "";
        }
    ...
    public static String toJsonNull(final Object object) {
        if (object == null) {
            return null;
        }
        return toJson(object);
    ...
    static Gson getGson4LogUtils() {
        ...
        if (gson4LogUtils == null) {
            gson4LogUtils = GsonFactory.newGsonBuilder().setPrettyPrinting().serializeNulls().create();
