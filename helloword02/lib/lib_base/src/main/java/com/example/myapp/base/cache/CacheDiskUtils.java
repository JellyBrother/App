...
import com.example.myapp.base.constant.CacheConstants;
...
public final class CacheDiskUtils implements CacheConstants {
    ...
    public static CacheDiskUtils getInstance(String cacheName, final long maxSize, final int maxCount) {
        ...
        File file = new File(CachePath.getUserCacheDir(), cacheName);
    ...
    private DiskCacheManager getDiskCacheManager() {
        if (mCacheDir.exists()) {
            ...
            if (mCacheDir.mkdirs()) {
                ...
                LogUtils.e("CacheDiskUtils", "can't make dirs in " + mCacheDir.getAbsolutePath());
            }
        }
