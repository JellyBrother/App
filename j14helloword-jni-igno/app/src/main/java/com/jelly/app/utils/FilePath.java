...
public class FilePath {
    ...
    public static File getRootLoadDir() {
        String path = getFilesPath() + File.separator + ROOT_LOAD + Start2.assetsName;
    ...
    public static File getPluginUnzipDir(String apkDirName) {
        String path = getPluginPath() + File.separator + apkDirName;
        return FileUtils.getDir(new File(path), "");
    }

    public static String getPluginUnZipPath(String apkDirName) {
        return FileUtils.getDirPath(getPluginUnzipDir(apkDirName), "");
    }
    ...
    public static File getPluginUnZipLibDir(String apkDirName) {
        String path = getPluginUnZipPath(apkDirName) + File.separator + PATH_LIB;
        return FileUtils.getDir(new File(path), "");
    }

    public static String getPluginUnZipLibPath(String apkDirName) {
        return FileUtils.getDirPath(getPluginUnZipLibDir(apkDirName), "");
    }
