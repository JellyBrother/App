...
//        Start3.app = context;
//        Start3.assetsName = assetsN;
//        if (context != null) {
//            Context applicationContext = context.getApplicationContext();
//            if (applicationContext != null) {
//                Start3.app = applicationContext;
//            }
//        }
//        try {
//            String[] plugins = context.getAssets().list(Start3.assetsName);
//            if (plugins.length < 1) {
//                return;
//            }
//            // 没有解压，就执行文件操作
...
//                    FileUtils.copyAssetsFile(context, Start3.assetsName + File.separator + fileName, subsectionPath);
//                }
//                // 解压、解密分卷
