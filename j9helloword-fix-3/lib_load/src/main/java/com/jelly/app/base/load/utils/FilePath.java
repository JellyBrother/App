...
public class FilePath {
    ...
    public static final String PATH_LIB2 = "lib2";
    ...
    public static File getPluginUnZipLibDir2() {
        String path = getPluginUnZipPath() + File.separator + PATH_LIB2;
        return FileUtils.getDir(new File(path), "");
    }

    public static String getPluginUnZipLibPath2() {
        return FileUtils.getDirPath(getPluginUnZipLibDir2(), "");
    }
}
