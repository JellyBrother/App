package com.jelly.wxtool.search.widget;
...
public class AddBySearchView extends View {
    private static final String TAG = "AddBySearchView";
    ...
    public AddBySearchView(Context context) {
        this(context, null, 0);
    }

    public AddBySearchView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AddBySearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AddBySearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
